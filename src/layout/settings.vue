  ...
  <div class="wrapper">
    <header class="nav-tab">
      ...
      <div class="btn-box">
        <a-button @click="showMenu()">
          <Icon icon="gravity-ui:bars" v-if="!isShowMenu"></Icon>
          <Icon icon="gravity-ui:xmark" v-else></Icon>
        </a-button>
      </div>
    </header>
    <div class="menu-mobile" v-if="isShowMenu">
      <a-menu
        ...
        :default-selected-keys="['settings-profile']"
      ...
      <div class="sidebar-wrapper__inner">
        <div class="sidebar">
          ...
          <div class="router-list">
            <a-menu
              @menu-item-click="menuItemClick"
              :default-selected-keys="[defaultRouteName]"
              :selected-keys="[defaultRouteName]"
              :auto-open-selected="true"
            >
              <template v-for="item in menuOptions">
                <a-sub-menu v-if="item.type === 'subMenu'" :key="item.key">
