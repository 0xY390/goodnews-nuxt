      ...
      <a-form :model="loginForm" @submit="handleSubmit" layout="vertical">
        <a-form-item
          ...
          :rules="[
            {
              required: true,
              message: `${t('login.currentPassword')}${t('common.required')}`
            }
          ]"
        >
          <a-input-password
        ...
        <a-form-item
          ...
          :rules="[
            {
              required: true,
              message: `${t('login.newPassword')}${t('common.required')}`
            }
          ]"
        >
          <a-input-password
        ...
        <a-form-item
          ...
          :rules="[
            {
              required: true,
              message: `${t('login.confirmPassword')}${t('common.required')}`
            }
          ]"
        >
          <a-input-password
        ...
        <a-button html-type="submit" long type="primary" :loading="loading">{{
          t('login.changePassword')
        }}</a-button>
      </a-form>
    </div>
