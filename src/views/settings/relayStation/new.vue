...
const rules = ref({
  inbox_url: [
    {
      required: true,
      message: t('admin.relay.pleaseEnterRelayDomain'),
      trigger: ['blur', 'change']
    }
  ]
})
  ...
  <div class="pages">
    ...
    >
      <a-form-item :label="t('admin.relay.relayInboxUrl')" field="inbox_url">
        <a-input
          v-model="formValue.inbox_url"
          :placeholder="t('admin.relay.pleaseEnterRelayUrl')"
        />
        <template #extra>
