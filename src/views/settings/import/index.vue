      ...
      >
        <a-row :gutter="16">
          <a-col :span="24">
            <a-form-item
              ...
              :extra="t('admin.importExport.importDesc')"
            >
        ...
        <a-row :gutter="16">
          <a-col :span="16">
            <a-form-item
              field="file"
              :label="t('admin.importExport.dataFile')"
              :extra="t('admin.importExport.dataFileDesc')"
            >
        ...
        <a-form-item>
          <a-button html-type="submit" long type="primary">{{
            t('common.upload')
          }}</a-button>
        </a-form-item>
      </a-form>
