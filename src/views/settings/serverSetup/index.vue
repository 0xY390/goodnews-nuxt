...
const getSettingAsync = async () => {
  try {
    ...
    const res = await asyncFunctions[fnName]()
...
const onSubmit = async () => {
  try {
    ...
    await asyncFunctions[fnName](params)
  ...
  <div class="pages">
    ...
    <a-spin :loading="loadingPage">
      <a-tabs v-model="tabsValue" @change="handleChange">
          ...
          <div class="pane-content">
            ...
            <a-form :model="formValue" layout="vertical">
              <a-row :gutter="24">
                <a-col :span="24">
                  <a-form-item :label="$t('admin.serverSetup.siteTitle')">
                    ...
                    <span class="formitem-tips">{{
                      $t('admin.serverSetup.siteTitleDesc')
                    }}</span>
                  </a-form-item>
                </a-col>
              </a-row>
              <a-row :gutter="24" class="user-email">
                <a-col ::span="12">
                  <a-form-item
                    :label="$t('admin.serverSetup.siteContactUsername')"
                  >
                    <a-input
                      v-model="formValue.formBranding.site_contact_username"
                    />
                    <span class="formitem-tips">{{
                      $t('admin.serverSetup.siteContactUsernameDesc')
                    }}</span>
                  </a-form-item>
                </a-col>
                <a-col ::span="12">
                  <a-form-item
                    :label="$t('admin.serverSetup.siteContactEmail')"
                  >
                    <a-input
                      v-model="formValue.formBranding.site_contact_email"
                    />
                    <span class="formitem-tips">{{
                      $t('admin.serverSetup.siteContactEmailDesc')
                    }}</span>
                  </a-form-item>
                </a-col>
              </a-row>
              <a-row :gutter="24">
                <a-col :span="24">
                  <a-form-item
                    :label="$t('admin.serverSetup.siteShortDescription')"
                  >
                    <a-textarea
                    ...
                    />
                    <span class="formitem-tips">{{
                      $t('admin.serverSetup.siteShortDescriptionDesc')
                    }}</span>
                  </a-form-item>
                </a-col>
              </a-row>
              ...
              <a-spin :loading="uploadLoading">
                <a-row class="form-item-online" justify="center" align="center">
                  ...
                  <a-col :span="12" class="flex">
                    <div
                      class="file-view"
                      v-if="formValue.formBranding?.thumbnail_url"
                    >
                      <div class="file-photo">
                        <img
                          :src="formValue.formBranding?.thumbnail_url"
                          alt=""
                        />
                      </div>
                    </div>
                ...
                <a-col :span="24">
                  <a-form-item>
                    <a-button
                      ...
                      class="submit-btn"
                      :loading="loadingSubmit || uploadLoading"
                      @click="onSubmit"
                      long
                      type="primary"
                      >{{ $t('admin.serverSetup.save') }}</a-button
                    >
                  </a-form-item>
                </a-col>
              </a-row>
              ...
              <a-row :gutter="24">
                <a-col :span="24">
                  <a-form-item :label="$t('admin.serverSetup.wholeDesc')">
                    <span class="formitem-tips">{{
                      $t('admin.serverSetup.wholeDesc')
                    }}</span>
                    <a-textarea
                      v-model="formValue.formAbout.site_extended_description"
                      :auto-size="true"
                    />
                    <div class="formitem-tips">
                      ...
                      <a
                        class="routerLink"
                        @click="goRouter('/settings/rule')"
                        >{{ $t('admin.serverSetup.serverRules') }}</a
                      >
                    </div>
                  </a-form-item>
                </a-col>
              ...
              <a-row :gutter="24">
                <a-col ::span="12">
                  <a-form-item :label="$t('admin.serverSetup.domainBlocks')">
                    <a-select
                      class="form-select"
                      v-model="formValue.formAbout.show_domain_blocks"
                      placeholder="Select"
                    >
                      <a-option
                        v-for="item in disableDomainList"
                        :key="item.value"
                        :label="item.text"
                        :value="item.value"
                      />
                ...
                <a-col ::span="12">
                  <a-form-item
                    :label="$t('admin.serverSetup.domainBlocksRationale')"
                  >
                    <a-select
                      class="form-select"
                      v-model="formValue.formAbout.show_domain_blocks_rationale"
                      placeholder="Select"
                    >
                      <a-option
              ...
              <a-row :gutter="24">
                <a-col :span="24">
                  <a-form-item :label="$t('admin.serverSetup.statusPageUrl')">
                    <span class="formitem-tips"
                      >{{ $t('admin.serverSetup.statusPageUrlDesc') }}。</span
                    >
              ...
              <a-row :gutter="24">
                <a-col :span="24">
                  <a-form-item :label="$t('admin.serverSetup.privacyPolicy')">
                    <span class="formitem-tips"
                      >{{ $t('admin.serverSetup.useDefault') }}
                    </span>
                    <a-textarea
                      v-model="formValue.formAbout.site_terms"
                      :auto-size="true"
                    />
                  </a-form-item>
                </a-col>
        ...
        <a-tab-pane
          key="Sitive"
          :title="$t('admin.serverSetup.sensitiveContentSetting')"
        >
          <div class="pane-content">
            <a-form :model="formValue" layout="vertical">
              <div class="checkbox-item">
                <a-checkbox
                  v-model="formValue.formSitive.receive_remote_sensitive"
                >
